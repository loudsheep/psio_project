...
import org.loudsheep.psio_project.backend.trading.formulas.MultiIndicatorFusionTradingFormula;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

public class MultiIndicatorFusionTradingFormulaValidator implements TradingFormulaValidator {
    public MultiIndicatorFusionTradingFormulaValidator() {
    }
    ...
    public String[] validate(Map<String, Object> formData) {
        ...
        } else if (!formData.containsKey("longEmaPeriod") || !(formData.get("longEmaPeriod") instanceof Number)) {
